function topImgs = siftSearch(queryImgName,AllFeatures)
% SIFTSEARCH Summary of this function goes here
% 
% [OUTPUTARGS] = SIFTSEARCH(INPUTARGS) Explain usage here
% 
% Examples: 
% 
